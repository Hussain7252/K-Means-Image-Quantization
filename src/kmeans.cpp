...
means: a std:vector of means, will contain the cluster means when the function
returns
labels: an allocated array of type int, the same size as the data, contains the
labels when the function returns
K: the number of clusters
maxIterations: maximum number of E-M interactions, default is 10
stopThresh: if the means change less than the threshold, the E-M loop terminates,
default is 0
